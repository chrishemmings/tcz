...
/* ---->  (Telnet)  Standard default TCZ prompt (%s replaced with TCZ MUD short name)  <---- */
#define TELNET_TCZ_PROMPT                  "%s>"

/* ---->  (HTML)  Standard default TCZ prompt (%s replaced with TCZ MUD short name)  <---- */
#define HTML_TCZ_PROMPT                    "%s command:"

/* ---->  (Telnet)  Prompt used when user is in BBS room (%s replaced with TCZ MUD short name)  <---- */
#define TELNET_BBS_PROMPT                  "%s BBS>"

/* ---->  (HTML)  Prompt used when user is in BBS room (%s replaced with TCZ MUD short name)  <---- */
#define HTML_BBS_PROMPT                    "%s BBS command:"

/* ---->  (Telnet)  Prompt used when user is in mail room (%s replaced with TCZ MUD short name)  <---- */
#define TELNET_MAIL_PROMPT                 "%s Mail>"

/* ---->  (HTML)  Prompt used when user is in mail room (%s replaced with TCZ MUD short name)  <---- */
#define HTML_MAIL_PROMPT                   "%s Mail command:"

/* ---->  (Telnet)  Prompt used when user is in bank room (%s replaced with TCZ MUD short name)  <---- */
#define TELNET_BANK_PROMPT                 "%s Bank>"

/* ---->  (HTML)  Prompt used when user is in bank room (%s replaced with TCZ MUD short name)  <---- */
#define HTML_BANK_PROMPT                   "%s Bank command:"
...
/* ---->  Enter prefered name prompt (Create)  <---- */
#define PREFERED_NAME_PROMPT               ANSI_LWHITE"\nYou need to think up a suitable name for your new character.  This "ANSI_LCYAN"does not"ANSI_LWHITE" need to be your real life name, and can be upto 20 letters in length and may contain spaces.\n\n"ANSI_LGREEN"Please enter your prefered character name:"
...
/* ---->  (Telnet)  Accept disclaimer terms and conditions prompt  <---- */
...
/* ---->  (HTML)  Accept disclaimer terms and conditions prompt  <---- */
#define HTML_ACCEPT_DISCLAIMER_PROMPT      "Do you accept the above terms and conditions (Type <I>ACCEPT</I>/<I>REJECT</I> in full)?"

/* ---->  (Telnet)  Choose character gender prompt (Create)  <---- */
...
/* ---->  (HTML)  Choose character gender prompt (Create)  <---- */
#define HTML_GENDER_PROMPT                 "Please enter your gender (<I>Male</I>, <I>Female</I> or <I>Neuter</I>):"

/* ---->  (Telnet)  Enter race prompt (Create)  <---- */
...
/* ---->  (HTML)  Enter race prompt (Create)  <---- */
#define HTML_RACE_PROMPT                   "Please enter your character's race:"

/* ---->  (Telnet)  Enter E-mail address prompt (Create) (%s replaced with TCZ Admin. E-mail address)  <---- */
...
/* ---->  (HTML)  Enter E-mail address prompt (Create)  <---- */
#define HTML_EMAIL_PROMPT                  "Please enter your full E-mail address:"

/* ---->  (Telnet)  Enter old password prompt ('@password')  <---- */
#define TELNET_OLD_PASSWORD_PROMPT         ANSI_LGREEN"Please enter your old password:"

/* ---->  (HTML)  Enter old password prompt ('@password')  <---- */
#define HTML_OLD_PASSWORD_PROMPT           "Please enter your old password:"

/* ---->  (Telnet)  Enter new password prompt ('@password')  <---- */
#define TELNET_NEW_PASSWORD_PROMPT         ANSI_LGREEN"Please enter a new password for your character:"

/* ---->  (HTML)  Enter new password prompt ('@password')  <---- */
#define HTML_NEW_PASSWORD_PROMPT           "Please enter a new password for your character:"

/* ---->  (Telnet)  Verify new password ('@password')  <---- */
#define TELNET_VERIFY_NEW_PASSWORD_PROMPT  ANSI_LGREEN"Please re-type your new password for verification:"

/* ---->  (HTML)  Verify new password ('@password')  <---- */
#define HTML_VERIFY_NEW_PASSWORD_PROMPT    "Please re-type your new password for verification:"
...
/* ---->  (Telnet)  Time difference prompt (Create) (1st %s = TCZ MUD full name, 2nd %s = Current time/date, 3rd %s = System time zone, 4th %s = Standard TCZ prompt)  <---- */
...
/* ---->  (HTML)  Time difference prompt (Create)  <----  */
#define HTML_TIME_DIFFERENCE_PROMPT        "Please enter your time difference:"
...
/* ---->  (Telnet)  Enter E-mail address prompt (Request for new character) (%s replaced with TCZ Admin. E-mail)  <---- */
...
/* ---->  (HTML)  Enter E-mail address prompt (Request for new character) (%s replaced with TCZ Admin. E-mail)  <---- */
#define HTML_REQUEST_EMAIL_PROMPT          "\n"ANSI_LWHITE"Sorry, new characters can no-longer be created from your site due to excessive abuse.  If you would like a character created, please enter your E-mail address at the prompt below.  Your request will be placed on a queue and we will be in touch with you shortly via E-mail.  If you experience any difficulties, please send E-mail to "ANSI_LYELLOW"%s"ANSI_LWHITE".\n\n"ANSI_LRED"If you do not wish to make a request for a new character, please type "ANSI_LYELLOW"NO"ANSI_LRED" at the prompt below.\n\n"ANSI_LGREEN"Please enter your E-mail address:"
