...
struct flag_data flag_list[] =
{
       ...
       {"Read-Only",           READONLY,     READONLY,     'r',  5|FLAG_LOG|FLAG_PERMISSION|FLAG_EXPERIENCED, BOOLFLAG_READONLY},
       ...
       {"ReadOnly",            READONLY,     READONLY,     '\0', 5|FLAG_LOG|FLAG_NOT_DISPLAY|FLAG_EXPERIENCED, BOOLFLAG_READONLY},
