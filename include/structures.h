...
struct db_player_data {
       ...
       char                   *shortdateformat;  /*  Prefered short date format  */
       char                   *longdateformat;   /*  Prefered long date format  */
       char                   *htmlbackground;   /*  Alternative HTML background image  */
       char                   *dateseparator;    /*  Prefered date/time separator  */
       ...
       char                   *timeformat;       /*  Prefered time format  */
       ...
       int                    dateorder;         /*  Prefered date/time order  */
...
struct request_data {
       ...
       char                  *name;    /*  Prefered character name  */
