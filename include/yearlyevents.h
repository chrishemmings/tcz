...
struct yearly_event_data yearly_events[] = {
       ...
       {NULL, "Record Peak of 122 Users",  05, 03, 00, 00, LONGDATEFMT,  0, 0,  "%y%lThe original TCZ MUD reached a record peak of %w%l122 users simultaneously%r%l on %y%l5th March 1996%r%l."},
       ...
       {NULL, "One Million Connections",   22, 06, 00, 00, LONGDATEFMT,  0, 0,  "%y%lThe original TCZ MUD reached a total of %w%lone million%r%l (Non-unique) connections on %y%lSunday 22nd June 1997%r%l."},
       ...
       {NULL, "Peak of 100 Users",         28, 11, 17, 26, FULLDATEFMT,  0, 0,  "%y%lThe original TCZ MUD reached a peak of %w%l100 users simultaneously%r%l for the first time on %y%l28th November 1995%r%l at %y%l5:26pm (GMT)%r%l."},
       ...
       {NULL, "TCZ Public GPL Release",    02, 12, 17, 39, LONGDATEFMT,  1, 0,  "%r%lThe %y%lTCZ source code%r%l was released publicly under the %w%lGNU General Public License%r%l (%w%l%(GPL%)%r%l) on %y%l02/12/2004%r%l (See '%w%l%<gpl%>%r%l' and visit %y%l%u%{@?link \"\" \"http://www.sourceforge.net/projects/tcz\" \"Click to visit the TCZ project web site...\"}%r%l"},
