...
extern  dbref           match_prefered          (dbref owner,dbref start,const char *searchstr,unsigned char startphase,unsigned char endphase,int types,int prefered,int options);
...
extern  dbref           query_find_object       (dbref player,const char *name,int prefered,unsigned char need_control,unsigned char private);
