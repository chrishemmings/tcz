       ...
       switch(*parsebuf) {
              ...
              default:
                   ...
                   *p-- = '\0';
                   ...
                   b->object = match_prefered(parse_character,parse_character,boolexp_buf,MATCH_PHASE_KEYWORD,MATCH_PHASE_GLOBAL,SEARCH_ALL,SEARCH_PREFERED,MATCH_OPTION_DEFAULT|MATCH_OPTION_RESTRICTED);
                   if(Valid(b->object))
