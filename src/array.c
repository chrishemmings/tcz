...
void array_sort(CONTEXT)
{
     ...
     array = match_prefered(player,player,arg1,MATCH_PHASE_KEYWORD,MATCH_PHASE_GLOBAL,SEARCH_ALL,SEARCH_ARRAY,MATCH_OPTION_DEFAULT);
...
void array_index(CONTEXT)
{
     ...
     setreturn(ERROR,COMMAND_FAIL);
     if(val1 == NOTHING) {
        thing = match_prefered(player,player,arg1,MATCH_PHASE_KEYWORD,MATCH_PHASE_GLOBAL,SEARCH_ALL,SEARCH_ARRAY,MATCH_OPTION_DEFAULT);
